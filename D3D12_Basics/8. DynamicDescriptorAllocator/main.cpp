    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_MY8DYNAMICDESCRIPTORALLOCATOR, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MY8DYNAMICDESCRIPTORALLOCATOR));
...
void Update()
{
    ...
    if (bDirChanged)
    {
        std::shared_ptr<void> pTemp = g_pTexHandle0;
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_MY8DYNAMICDESCRIPTORALLOCATOR));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_MY8DYNAMICDESCRIPTORALLOCATOR);
